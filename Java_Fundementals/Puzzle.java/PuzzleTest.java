...
public class PuzzleTest {
    public static void main(String[] args){
        ...
        // System.out.println(Arrays.toString(pz.numbersAyEshe())); //first way to print
        // for(int i : pz.numbersAyEshe()) //another way to print using for loop
        //     System.out.print(i+" ");
